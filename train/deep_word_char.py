...
from model.deepzoo import get_word_char_cnn_v2
...
model = get_word_char_cnn_v2(Config.word_seq_maxlen, Config.char_seq_maxlen, word_embed_weight, char_embed_weight)
...
for i in range(15):
    ...
    print("recall", rec)
    print("f1_score", f1)
    model.save(Config.cache_dir + "/deep_word_char/dp_embed_%s_epoch_%s_%s.h5"%(model_name, i, f1))