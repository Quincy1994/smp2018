...
from model.deepzoo import get_word_rcnn_char_rnn
...
model = get_word_rcnn_char_rnn(Config.word_seq_maxlen, Config.char_seq_maxlen, word_embed_weight, char_embed_weight)
...
for i in range(15):
    ...
    print("f1_score", f1)
    if i > 6:
        model.save(Config.cache_dir + "/word_rcnn_char_rnn_v2/dp_embed_%s_epoch_%s_%s.h5"%(model_name, i, f1))
