...
from model.deepzoo import get_word_rnn_char_rcnn
...
model = get_word_rnn_char_rcnn(Config.word_seq_maxlen, Config.char_seq_maxlen, word_embed_weight, char_embed_weight)
...
for i in range(15):
    ...
    if i > 5:
        ...
        print("recall", rec)
        print("f1_score", f1)
        model.save(Config.cache_dir + "/word_rnn_char_rcnn_v2/dp_embed_%s_epoch_%s_%s.h5"%(model_name, i, f1))
